...
#define PERSIST_KEY_ID_STOP_PICK_TIMER_0 5
#define PERSIST_KEY_ID_STOP_PICK_TIMER_1 6
#define PERSIST_KEY_ID_STOP_PICK_TIMER_2 7
#define PERSIST_KEY_ID_STOP_PICK_TIMER_3 8
#define PERSIST_KEY_ID_STOP_PICK_TIMER_4 9
